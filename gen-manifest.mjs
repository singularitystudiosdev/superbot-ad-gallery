...
const more = [
  ...
  ['agent-workspace-superbot-e55f63e5', 'agent-workspace-superbot-e55f63e5/', 'your all-in-one agent workspace — the superbot.gg hero box 1:1 (apps spin, mark flip, rail dropdown, frontend display), the email prompt + reply, then 1:1 Gmail where the agent opens, answers and sends every thread in your style (36.9s loop)', 'Ad spots'],

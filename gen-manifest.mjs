...
const more = [
  ...
  ['agents-managed-superbot-6f50ea56', 'agents-managed-superbot-6f50ea56/', 'one agent? ChatGPT hands back a 14-step how-to, superbot splits a bakery website across Cursor, Claude, Gemini and ChatGPT and puts it online (27s loop)', 'Ad spots'],

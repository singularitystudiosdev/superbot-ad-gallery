...
const more = [
  ['icons-bounce-slam-superbot-9c4e17b3', 'icons-bounce-slam-superbot-9c4e17b3/', 'skills + app icons pop in and bounce, pack tight, the superbot mark flips in and slams them back, vacuums them in, spits out organized lists + an apps dropdown, then the tagline and lockup (21.6s loop)', 'Ad spots'],
  ['ai-aggregator-superbot-a3f7c25e', 'ai-aggregator-superbot-a3f7c25e/', 'the AI aggregator is here — the site expand beat, cursor clicks through every chat at 0.8s, pink/blue/purple tagline, superbot.gg end lockup (19.6s loop)', 'Ad spots'],

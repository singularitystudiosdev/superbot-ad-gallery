...
const more = [
  ...
  ['do-that-too-superbot-9b4bf902', 'do-that-too-superbot-9b4bf902/', 'I can do that too! "All your agents in one": the tabs die into the superbot mark, then it answers Lovable (an iPhone app that makes apps, live in a phone emulator), Cursor (connects GitHub, fixes a bug, ships PR #142) and DoorDash (a burger, "Ordered!"), then what the others can\'t: 10 YouTube videos to MP3 (The Final Countdown, Sandstorm, Pump It Up...). (64.1s loop)', 'Ad spots'],
  ...
  ['free-tokens-still-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/free-tokens-still.html', 'FREE TOKENS · still (6s loop)', 'Ad spots'],
  ['free-tokens-type-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/free-tokens-type.html', 'FREE TOKENS · typed (6s loop)', 'Ad spots'],
  ['free-tokens-slam-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/free-tokens-slam.html', 'FREE TOKENS · slam (6s loop)', 'Ad spots'],
  ['comments-still-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/comments-still.html', 'FIRST 100 COMMENTS = EARLY ACCESS · still (6s loop)', 'Ad spots'],
  ['comments-counter-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/comments-counter.html', 'FIRST 100 COMMENTS = EARLY ACCESS · counter (7.5s loop)', 'Ad spots'],
  ['comments-beats-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/comments-beats.html', 'FIRST 100 COMMENTS = EARLY ACCESS · beats (6s loop)', 'Ad spots'],
  ...
  ['wait-for-it-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/wait-for-it.html', 'WAIT FOR IT... · then comment AGAIN (7.5s loop)', 'Ad spots'],
  ...
  ['comment-superbot-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/comment-superbot.html', 'COMMENT \'SUPERBOT\' · reply bot (9s loop)', 'Ad spots'],
  ['like-meter-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/like-meter.html', 'LIKES UNLOCK CODES · like meter (8s loop)', 'Ad spots'],
  ['tag-a-friend-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/tag-a-friend.html', 'TAG A FRIEND · two for one (8s loop)', 'Ad spots'],
  ['not-a-robot-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/not-a-robot.html', 'I\'M NOT A ROBOT · captcha confession (9s loop)', 'Ad spots'],
  ['find-happy-one-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/find-happy-one.html', 'FIND THE HAPPY ONE · crowd puzzle (8s loop)', 'Ad spots'],
  ['like-if-you-saw-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/like-if-you-saw.html', 'LIKE IF YOU SAW IT · one frame (7s loop)', 'Ad spots'],
  ['token-odometer-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/token-odometer.html', 'FREE TOKENS · 1,000,000 odometer (7s loop)', 'Ad spots'],
  ['hypno-rings-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/hypno-rings.html', 'FREE TOKENS · hypno rings (8s loop)', 'Ad spots'],
  ['ready-set-go-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/ready-set-go.html', 'READY SET GO · FREE TOKENS start lights (6s loop)', 'Ad spots'],
  ['scratch-card-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/scratch-card.html', 'FREE TOKENS · scratch card (7.5s loop)', 'Ad spots'],
  ['early-door-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/early-door.html', 'EARLY ACCESS · FIRST 100 COMMENTS doors (8.6s loop)', 'Ad spots'],
  ['tokens-stack-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/tokens-stack.html', 'FREE TOKENS · TOKENS avalanche (7s loop)', 'Ad spots'],
  ['matrix-rain-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/matrix-rain.html', 'CATCH ONE · code rain (8s loop)', 'Ad spots'],
  ['ticker-tokens-superbot-d7bc1ed7', 'mascot-codes-superbot-d7bc1ed7/ticker-tokens.html', 'FREE TOKENS · ticker (8s loop)', 'Ad spots'],

...
const more = [
  ...
  ['nine-plus-ten-superbot-7d3e9b21', 'nine-plus-ten-superbot-7d3e9b21/', 'what\'s 9 + 10? · the Vine kid asks with the ChatGPT icon on his head; ChatGPT shows its work forever and the camera flies down the wall; the kid asks again wearing the superbot icon; superbot, in blue, pink and purple: "21." · stop burning tokens · the end card (28s loop, with sound)', 'Ad spots'],

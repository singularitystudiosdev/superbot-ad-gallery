...
const more = [
  ...
  ['gpt-slowdown-superbot-05dcc43a', 'gpt-slowdown-superbot-05dcc43a/', 'agents getting slowww? superbot can do it — ChatGPT 1:1 email stream 300→10 wpm, popup + chat bubble, click into the superbot.gg intro, 43-rules cleanup prompt, gradient cards, lockup (42.6s loop)', 'Ad spots'],

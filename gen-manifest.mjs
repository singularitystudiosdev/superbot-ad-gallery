...
const more = [
  ...
  ['waffles-delivery-superbot-87a583a1', 'waffles-delivery-superbot-87a583a1/', 'order me waffles? ChatGPT lectures "I can\'t do that!"; superbot pops in, orders Denny\'s through DoorDash, a 3s real doorstep handoff plays with the superbot mascot on the courier\'s shoulder, and it hops into the end card (17.4s loop)', 'Ad spots'],

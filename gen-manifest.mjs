...
const more = [
  ...
  ['deny-cascade-superbot-440813d4', 'deny-cascade-superbot-440813d4/', '"ask me anything" — ChatGPT denies 35 prompts in 7 seconds, then superbot answers every single one (~22s loop)', 'Ad spots'],
  ['deny-cascade-split-superbot-440813d4', 'deny-cascade-split-superbot-440813d4/', 'the same 35 questions, side by side — ChatGPT denies on the left while superbot answers at the same tempo on the right (~14.5s loop)', 'Ad spots'],
  ['deny-cascade-counter-superbot-440813d4', 'deny-cascade-counter-superbot-440813d4/', 'the denial counter — 35 refusals tick up, then superbot runs the score back: 35 answered (~22s loop)', 'Ad spots'],

...
const more = [
  ...
  ['tuneup-rules-a-a1b6c9d3', 'tuneup-rules-a-a1b6c9d3/', "VARIANT A, ignored rules: the dev states the rules and the agent breaks them in the same breath, three times; superbot pulls the rules out of the chat and wires them into every session (28.0s loop)", 'Ad spots'],
  ['tuneup-ramble-b-e5f2078a', 'tuneup-ramble-b-e5f2078a/', "VARIANT B, the ramble: one bug fix asked, an endless restarting monologue delivered; superbot curates skills and trims context, and the same ask lands in one line (28.0s loop)", 'Ad spots'],
  ['agent-tuneup-superbot-cc47ab91', 'agent-tuneup-superbot-cc47ab91/', "your agent's a mess? chatgpt flails at a simple trip plan, forgetting what you just told it; the superbot popup tunes your rules and skills, and the same question lands instantly on the first try (26.2s loop)", 'Ad spots'],
  ['agents-breaking-superbot-3e8a17c2', 'agents-breaking-superbot-3e8a17c2/', "agents breaking your code? one small ask, and the agent renames, migrates, deletes and refactors half the codebase on its own; superbot hands back exactly the endpoint, nothing else touched (21.9s loop)", 'Ad spots'],
  ['permission-fatigue-superbot-9b4d12e8', 'permission-fatigue-superbot-9b4d12e8/', "permission fatigue? one deploy ask, and the agent answers with a wall of may-I questions; superbot runs the whole thing in one go, zero prompts (21.9s loop)", 'Ad spots'],

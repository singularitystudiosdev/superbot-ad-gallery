...
const more = [
  ...
  ['agents-breaking-superbot-3e8a17c2', 'agents-breaking-superbot-3e8a17c2/', "agents breaking your code? the agent rewrites auth.py in its own style, swaps the test framework, deletes the failing tests and shotgun-debugges; superbot stops at the third strike, reverts and asks (24.4s loop)", 'Ad spots'],
  ['permission-fatigue-superbot-9b4d12e8', 'permission-fatigue-superbot-9b4d12e8/', "permission fatigue? the agent asks before every tiny step, eleven dialogs approved faster and faster until nobody reads them; superbot runs the whole task in one go, zero prompts (23.7s loop)", 'Ad spots'],

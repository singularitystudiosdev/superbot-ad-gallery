...
const more = [
  ['icons-chaos-slam-superbot-544078ab', 'icons-chaos-slam-superbot-544078ab/', 'SKILL.md and mcp.json chaos — 84 agent files + 36 app icons bounce like a dvd screensaver, superbot slams in, sucks them in, spits out organized lists, "Your agent, for your agents" (13.4s loop)', 'Ad spots'],

...
const more = [
  ...
  ['do-that-too-superbot-9b4bf902', 'do-that-too-superbot-9b4bf902/', 'I can do that too! "All your agents in one": the tabs die into the superbot mark, then it answers Lovable (an iPhone app that makes apps, live in a phone emulator), Cursor (connects GitHub, fixes a bug, ships PR #142) and DoorDash (a burger, "Ordered!"), then what the others can\'t: 10 YouTube videos to MP3. (67.9s loop)', 'Ad spots'],

...
const more = [
  ['ai-aggregator-chat-tour', 'ai-aggregator-chat-tour/', 'The AI Aggregator is here — frontend expand, agent icons merge into superbot, cursor clicks through every chat at a 0.900s metronome (15s loop)', 'Ad spots'],
